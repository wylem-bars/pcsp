...
Alias : $pat-id-hulafe = http://hl7.eu/fhir/ig/pcsp/sid/pat-id-hulafe
Alias : $pat-id-vulsk = http://hl7.eu/fhir/ig/pcsp/sid/pat-id-vulsk
Alias : $pat-id-mainz = http://hl7.eu/fhir/ig/pcsp/sid/pat-id-mainz
Alias : $org-id-mainz = http://hl7.eu/fhir/ig/pcsp/sid/org-id-mainz
